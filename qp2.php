...
$sql = "SELECT question2 FROM questions WHERE id = 1";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);
?>
<textarea id="myText">question2:
  <?php   echo $row['question2'] ?></textarea>
<?php
  mysqli_close($conn);
?>
            ...
            <div class="input-single">
                <form action ="qp2put.php" method="post">
  ...
  if($column = mysqli_fetch_assoc($result))
          {
           ...
           <?php echo $column['answer2']; ?></textarea>
          </form>
           <?php
          }
        ?>
        ...
        {
          $query = "DELETE from note2 where id=1";
