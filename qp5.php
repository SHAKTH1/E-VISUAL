...
$sql = "SELECT question5 FROM questions WHERE id = 1";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);
?>
<textarea id="myText">question5:
  <?php   echo $row['question5'] ?></textarea>
<?php
  mysqli_close($conn);
?>
            ...
            <div class="input-single">
                <form action ="qp5put.php" method="post">
  ...
  if($column = mysqli_fetch_assoc($result))
          {
           ...
           <?php echo $column['answer5']; ?></textarea>
          </form>
           <?php
          }
        ?>
        ...
        {
          $query = "DELETE from note5 where id=1";
