...
$sql = "SELECT question4 FROM questions WHERE id = 1";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($result);
?>
<textarea id="myText">question4: <?php echo $row['question4'] ?></textarea>
<?php
  mysqli_close($conn);
?>
            ...
            <div class="input-single">
                <form action ="qp4put.php" method="post">
  ...
  if($column = mysqli_fetch_assoc($result))
          {
           ...
           <?php echo $column['answer4']; ?></textarea>
          </form>
           <?php
          }
        ?>
     ...
     $connection = mysqli_connect("sql203.epizy.com", "epiz_33483613", "boLxD4xhCkj76fF");
        ...
        {
          $query = "DELETE from note4 where id=1";
